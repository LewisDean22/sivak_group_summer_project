...
TAU_C_FILENAME = "power_against_correlation_time_gain_2.5_model_1.csv"
D_NE_FILENAME = "power_against_noise_strength_gain_2.5_model_1.csv"
GAIN_FILENAME = "power_against_feedback_gain_model_1.csv"

PLOT_CORRELATION_TIME_DATA = 1
PLOT_NOISE_STRENGTH_DATA = 1
PLOT_GAIN_DATA = 1
SAVE_PLOTS = 1
...
def tau_c_gaussian_bath_powers(d_ne, gain, delta_g):
    '''
...
def main(tau_c_filename=TAU_C_FILENAME, d_ne_filename=D_NE_FILENAME,
    ...
    if PLOT_CORRELATION_TIME_DATA:
        ...
        if CALCULATE_LOW_LIMITS:
            tau_c_low_power_limit = tau_c_gaussian_bath_powers(TAU_C_D_NE, tau_c_gain,
                                                                 TAU_C_DELTA_G)
        else:
